...
st.image("./Image/visu2.png", caption="Poporciones de la variable solids, y de potability en estas")
...
st.image("./Image/visu3.png", caption="Poporciones de la variable hardness, y de potability en estas")
...
st.image("./Image/visu4.png",caption="Poporciones de la variable Chloramiines, y de potability en estas")
...
st.image("./Image/visu5.png",caption="Poporciones de la variable sulfure, y de potability en estas")
...
st.image("./Image/visu6.png",caption="Poporciones de la variable conductivity, y de potability en estas")
...
st.image("./Image/visu.png7",caption="Poporciones de la variable organic_carbon, y de potability en estas")
...
st.image("./Image/visu8.png",caption="Poporciones de la variable trihalomethanes, y de potability en estas")
...
st.image("./Image/visu9.png",caption="Poporciones de la variable turbidity, y de potability en estas")
...
st.image("./Image/propo1.png",caption="Proporcion de la variable potability")
...
st.image("./Image/rela1.png")
st.image("./Image/pair1.png")
st.write("Para mostrar la relación entre dos distribucciones realizamos boxplots, todos respecto a la variable objeto.")
st.image("./Image/box1.png",caption="Boxlpot de la variable ph" )
st.image("./Image/box2.png",caption="Boxlpot de la variable hardness" )
st.image("./Image/box3.png",caption="Boxlpot de la variable solids" )
st.image("./Image/box4.png",caption="Boxlpot de la variable chloramines" )
st.image("./Image/box5.png",caption="Boxlpot de la variable sulfate" )
st.image("./Image/box6.png",caption="Boxlpot de la variable conductivity" )
st.image("./Image/box7.png",caption="Boxlpot de la variable organic_carbon" )
st.image("./Image/box8.png",caption="Boxlpot de la variable trihalomethanes" )
st.image("./Image/box9.png",caption="Boxlpot de la variable turbidity" )
