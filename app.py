...
st.image("./Image/visu2", caption="Poporciones de la variable solids, y de potability en estas")
...
st.image("./Image/visu3", caption="Poporciones de la variable hardness, y de potability en estas")
...
st.image("./Image/visu4",caption="Poporciones de la variable Chloramiines, y de potability en estas")
...
st.image("./Image/visu5",caption="Poporciones de la variable sulfure, y de potability en estas")
...
st.image("./Image/visu6",caption="Poporciones de la variable conductivity, y de potability en estas")
...
st.image("./Image/visu7",caption="Poporciones de la variable organic_carbon, y de potability en estas")
...
st.image("./Image/visu8",caption="Poporciones de la variable trihalomethanes, y de potability en estas")
...
st.image("./Image/visu9",caption="Poporciones de la variable turbidity, y de potability en estas")
...
st.image("./Image/propo1",caption="Proporcion de la variable potability")
...
st.image("./Image/rela1")
st.image("./Image/pair1")
st.write("Para mostrar la relación entre dos distribucciones realizamos boxplots, todos respecto a la variable objeto.")
st.image("./Image/box1",caption="Boxlpot de la variable ph" )
st.image("./Image/box2",caption="Boxlpot de la variable hardness" )
st.image("./Image/box3",caption="Boxlpot de la variable solids" )
st.image("./Image/box4",caption="Boxlpot de la variable chloramines" )
st.image("./Image/box5",caption="Boxlpot de la variable sulfate" )
st.image("./Image/box6",caption="Boxlpot de la variable conductivity" )
st.image("./Image/box7",caption="Boxlpot de la variable organic_carbon" )
st.image("./Image/box8",caption="Boxlpot de la variable trihalomethanes" )
st.image("./Image/box9",caption="Boxlpot de la variable turbidity" )
